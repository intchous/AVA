...
describe('Chart Type - Stacked Column Chart', () => {
  it('2series - complete', async () => {
    const div = createDiv('2 series - complete data - Stacked ColumnCharts');
  ...
  it('2series - incomplete', async () => {
    const div = createDiv('2 series - incomplete data - Stacked ColumnCharts');
    div.style.height = '400px';
    div.style.boxSizing = 'border-box';
  ...
  it('3series - complete', async () => {
    const div = createDiv('3 series - incomplete data - Stacked ColumnCharts');
    div.style.height = '400px';
    div.style.boxSizing = 'border-box';
